...
import com.urk17cs290.mediaplayer.music.fragments.FileFragment;
import com.urk17cs290.mediaplayer.music.fragments.FragmentAlbum;
import com.urk17cs290.mediaplayer.music.fragments.FragmentArtist;
import com.urk17cs290.mediaplayer.music.fragments.FragmentGenre;
import com.urk17cs290.mediaplayer.music.fragments.FragmentPlaylist;
import com.urk17cs290.mediaplayer.music.fragments.FragmentSongs;
import com.urk17cs290.mediaplayer.music.fragments.HomeFragment;
...
public class MainScreen extends BaseActivity implements MediaController.MediaPlayerControl {
    ...
    private void createDrawer() {
        ...
        accountHeader = new AccountHeaderBuilder().withActivity(this)
                ...
                .addProfiles(
                        new ProfileDrawerItem().withName("music - Music Player").withIcon(R.mipmap.ic_launcher_round)
                ).build();
        ...
        drawer = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(R.string.genres).withIcon(ExtraUtils.getThemedIcon(this, getDrawable(R.drawable.ic_genre))).withIdentifier(4).withSelectable(true),
                        new PrimaryDrawerItem().withName(R.string.albums).withIcon(ExtraUtils.getThemedIcon(this, getDrawable(R.drawable.ic_album))).withIdentifier(5).withSelectable(true),
                ...
                .addStickyDrawerItems(
                    ...
                    if (drawerItem != null) {
                        ...
                        if (drawerItem.getIdentifier() == 1) {
                            ...
                            ExtraUtils.openCustomTabs(MainScreen.this, "https://github.com/samuelrajasingh");
                            drawer.closeDrawer();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (Main.musicService == null || Main.musicService.isPlaying())
