...
public class Data {
     ...
     */
    private Map<String, String> genreIdToGenreNameMap = new HashMap<>();
     ...
     * @note It's only available after calling `scanSongs`.
     */
    private Map<String, String> songIdToGenreIdMap = new HashMap<>();
    ...
    public void updatePlaylists(Context context, String fromWhere) {
        ...
        Collections.sort(playlists, (a, b) -> a.getName().compareTo(b.getName()));
