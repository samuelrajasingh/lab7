package com.urk17cs290.mediaplayer.music.services;
...
import com.urk17cs290.mediaplayer.music.handlers.NotificationHandler;
...
public class ServicePlayMusic extends MediaBrowserServiceCompat
    ...
    public static final String ACTION_CMD = "com.urk17cs290.mediaplayer.music.ACTION_CMD";
     ...
     * @param theSongs list of songs List<Song>
     */
    ...
    public void playSong() {
        ...
        if (Main.settings.get("saveRecent", true))
            RecentUtils.addsongToRecent(getApplicationContext(), songToPlay);
    ...
    public void toggleShuffle() {
        ...
        } else Collections.sort(songs, (o1, o2) -> o1.getTitle().compareTo(o2.getTitle()));
    }
